...
<meta charset="utf-8">
	...
	<title>اخبار و تحلیل های روز ارز های دیجیتال</title>
...
<body>
    ...
    <div id="cards">
		...
		?>
		<div id="card">
			<a href="news-index.php?id=<?php echo $value->id; ?>"><img id="card__image" src="<?php echo $value->cover; ?>" alt="wave" width="250px" height="150px" /></a>
			<div id="card-title">
				<a href="#" id="toggle-info btn">
					<span id="left"></span>
					<span id="right"></span>
				</a>
				<a href="news-index.php?id=<?php echo $value->id; ?>"><h2><?php echo $value->title; ?><small><?php echo $value->Summary; ?></small></h2></a>
			</div>
